...
public class DefaultAudioPlayerManager implements AudioPlayerManager {
    ...
    private List<AudioSourceManager> sourceManagers;
    ...
    // Executors
    private ExecutorService trackPlaybackExecutorService;
    private ThreadPoolExecutor trackInfoExecutorService;
    private ScheduledExecutorService scheduledExecutorService;
    private OrderedExecutor orderedInfoExecutor;

    // Configuration
    private volatile long trackStuckThreshold;
    private volatile AudioConfiguration configuration;
    private AtomicLong cleanupThreshold;
    ...
    public DefaultAudioPlayerManager() {
        ...
        try {
            ...
            e.printStackTrace();
            ChadException.error("#DefaultAudioPlayerManager(): " + e);
        }
    }
    ...
    private AudioItem checkSourcesForItemOnce(AudioReference reference, AudioLoadResultHandler resultHandler, boolean[] reported) {
        for (AudioSourceManager sourceManager : sourceManagers) {
            if (!(sourceManager instanceof ProbingAudioSourceManager)) {
                continue;
            }
