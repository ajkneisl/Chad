...
import com.jhobot.handle.ui.panels.GuildPanel;
import com.jhobot.handle.ui.panels.MainPanel;
import com.jhobot.handle.ui.panels.PopUpPanel;
...
public class UIHandler
{
    ...
    private void beginMainFrame()
    {
        ...
        mainpanel.getAllGuilds.addActionListener((ActionEvent) -> ChadBot.cli.getGuilds().forEach((g) -> {
            add();
            addLog("<" + i + "> "+g.getName()+" ["+g.getStringID()+"]");
        }));
