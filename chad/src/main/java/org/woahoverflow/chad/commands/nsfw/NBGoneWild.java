...
public class NBGoneWild implements Command.Class  {
    ...
    public Runnable run(MessageReceivedEvent e, List<String> args) {
        return() -> {
            ...
            b.withImage(ChadVar.JSON_HANDLER.read("https://nekobot.xyz/api/image?type=gonewild").getString("message"));
    ...
    public Runnable help(MessageReceivedEvent e, List<String> args) {
        ...
        return Command.helpCommand(st, "Gone Wild", e);
    }
}
