    ...
    public Runnable run(MessageReceivedEvent e, List<String> args) {
        return () -> {
            ...
            if (args.size() >= 2 && args.get(0).equalsIgnoreCase("join"))
            {
                ...
                String old = ChadVar.DATABASE_DEVICE.getString(e.getGuild(), "join_message");
                ChadVar.DATABASE_DEVICE.set(e.getGuild(), "join_message", sb.toString().trim());
            ...
            if (args.size() >= 2 && args.get(0).equalsIgnoreCase("leave"))
            {
                ...
                String old = ChadVar.DATABASE_DEVICE.getString(e.getGuild(), "leave_message");
                ChadVar.DATABASE_DEVICE.set(e.getGuild(), "leave_message", sb.toString().trim());
            ...
            if (args.size() >= 2 && args.get(0).equalsIgnoreCase("ban"))
            {
                ...
                String old = ChadVar.DATABASE_DEVICE.getString(e.getGuild(), "ban_message");
                ChadVar.DATABASE_DEVICE.set(e.getGuild(), "ban_message", sb.toString().trim());
            ...
            if (args.size() >= 2 && args.get(0).equalsIgnoreCase("kick"))
            {
                ...
                String old = ChadVar.DATABASE_DEVICE.getString(e.getGuild(), "kick_message");
                ChadVar.DATABASE_DEVICE.set(e.getGuild(), "kick_message", sb.toString().trim());
            ...
            if (args.size() == 3 && args.get(0).equalsIgnoreCase("toggle"))
            {
                ...
                if (args.get(1).equalsIgnoreCase("join"))
                {
                    ...
                    m.sendConfigLog("Kick Message Toggle", Boolean.toString(set), Boolean.toString(ChadVar.DATABASE_DEVICE.getBoolean(e.getGuild(),"join_msg_on")), e.getAuthor(), e.getGuild());
                ...
                if (args.get(1).equalsIgnoreCase("ban"))
                {
                    ...
                    m.sendConfigLog("Kick Message Toggle", Boolean.toString(set), Boolean.toString(ChadVar.DATABASE_DEVICE.getBoolean(e.getGuild(),"ban_msg_on")), e.getAuthor(), e.getGuild());
                ...
                if (args.get(1).equalsIgnoreCase("kick"))
                {
                    ...
                    m.sendConfigLog("Kick Message Toggle", Boolean.toString(set), Boolean.toString(ChadVar.DATABASE_DEVICE.getBoolean(e.getGuild(),"kick_msg_on")), e.getAuthor(), e.getGuild());
                ...
                if (args.get(1).equalsIgnoreCase("leave"))
                {
                    ...
                    m.sendConfigLog("Leave Message Toggle", Boolean.toString(set), Boolean.toString(ChadVar.DATABASE_DEVICE.getBoolean(e.getGuild(),"leave_msg_on")), e.getAuthor(), e.getGuild());
